...
{
    const BRED_ANIMALS = "minecraft:bred_animals";
    const BREWED_POTION = "minecraft:brewed_potion";
    const CONSUME_ITEM = "minecraft:consume_item";
    const CRAFTER_RECIPE_CRAFTED = "minecraft:crafter_recipe_crafted";
